...
def prepare_arrays_match():
    ...
    while 1:
        ...
        if srch_ci != 'nan':
            srch_ci_year = int(srch_ci[:4])
            srch_ci_month = int(srch_ci[5:7])
            srch_ci_day = int(srch_ci[8:10])
        else:
            srch_ci_year = int(arr[0][:4])
            srch_ci_month = int(arr[0][5:7])
            srch_ci_day = int(arr[0][8:10])

        if srch_co != 'nan':
            srch_co_year = int(srch_co[:4])
        ...
        srch_people_cnt = srch_adults_cnt + srch_children_cnt
        ...
        if user_id != '' and srch_destination_id != '' and srch_ci_month != '' and srch_co_month != '':
...
def gen_submission(best_s00, best_s01,best_s02, best_hotels_country, best_hotels_search_dest, best_hotels_od_ulc, best_hotels_uid_miss, monthly_popular_hotel_cluster):
    ...
    while 1:
        ...
        if srch_ci != 'nan':
            ...
            srch_ci_year = int(arr[1][:4])
            srch_ci_month = int(arr[1][5:7])
            srch_ci_day = int(arr[1][8:10])

        if srch_co != 'nan':
            srch_co_year = int(srch_co[:4])
            srch_co_month = int(srch_co[5:7])
            srch_co_day = int(srch_co[8:10])
            length_of_stay = (date(srch_co_year, srch_co_month, srch_co_day) - date(srch_ci_year, srch_ci_month, srch_ci_day)).days
        else:
            srch_co_month = ''
            length_of_stay = ''
...
best_s00,best_s01, best_s02, best_hotels_country, best_hotels_od_ulc, best_hotels_uid_miss, best_hotels_search_dest, monthly_popular_hotel_cluster = prepare_arrays_match()
