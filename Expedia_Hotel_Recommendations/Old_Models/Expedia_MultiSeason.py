    ...
    while 1:
        ...
        if season == "Spring":
            ...
            if user_location_city != '' and orig_destination_distance != '':
                ...
                hsh1 = (hash('Summer' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
                hsh2 = (hash('Fall' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
                hsh3 = (hash('Winter' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))

                best_hotels_od_ulc[hsh][hotel_cluster] += append_0
                best_hotels_od_ulc[hsh1][hotel_cluster] += append_0 * (2/3)
                best_hotels_od_ulc[hsh2][hotel_cluster] += append_0 * (2/3)
                best_hotels_od_ulc[hsh3][hotel_cluster] += append_0 * (2/3)
            ...
            if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and book_year == 2014:
                ...
                hsh1 = (hash('Summer' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
                hsh2 = (hash('Fall' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
                hsh3 = (hash('Winter' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))

                best_hotels_search_dest[hsh][hotel_cluster] += append_1
                best_hotels_search_dest[hsh1][hotel_cluster] += append_1*(2/3)
                best_hotels_search_dest[hsh2][hotel_cluster] += append_1*(2/3)
                best_hotels_search_dest[hsh3][hotel_cluster] += append_1*(2/3)

            if srch_destination_id != '':
                hsh = hash('Spring' + 'srch_destination_id_'+str(srch_destination_id))
                hsh1 = hash('Summer' + 'srch_destination_id_'+str(srch_destination_id))
                hsh2 = hash('Fall' + 'srch_destination_id_'+str(srch_destination_id))
                hsh3 = hash('Winter' + 'srch_destination_id_'+str(srch_destination_id))

                best_hotels_search_dest1[hsh][hotel_cluster] += append_1
                best_hotels_search_dest1[hsh1][hotel_cluster] += append_1*(2/3)
                best_hotels_search_dest1[hsh2][hotel_cluster] += append_1*(2/3)
                best_hotels_search_dest1[hsh3][hotel_cluster] += append_1*(2/3)

            if hotel_country != '':
                hsh = hash('Spring' + 'hotel_country_'+str(hotel_country))
                hsh1 = hash('Summer' + 'hotel_country_'+str(hotel_country))
                hsh2 = hash('Fall' + 'hotel_country_'+str(hotel_country))
                hsh3 = hash('Winter' + 'hotel_country_'+str(hotel_country))

                best_hotel_country[hsh][hotel_cluster] += append_2
                best_hotel_country[hsh1][hotel_cluster] += append_2*(2/3)
                best_hotel_country[hsh2][hotel_cluster] += append_2*(2/3)
                best_hotel_country[hsh3][hotel_cluster] += append_2*(2/3)
        ...
        if season == "Summer":
            ...
            if user_location_city != '' and orig_destination_distance != '':
                ...
                hsh1 = (hash('Fall' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
                hsh2 = (hash('Winter' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
                hsh3 = (hash('Spring' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
            ...
            if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and book_year == 2014:
                ...
                hsh1 = (hash('Fall' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
                hsh2 = (hash('Winter' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
                hsh3 = (hash('Spring' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
            ...
            if srch_destination_id != '':
                ...
                hsh1 = hash('Fall' + 'srch_destination_id_'+str(srch_destination_id))
                hsh2 = hash('Winter' + 'srch_destination_id_'+str(srch_destination_id))
                hsh3 = hash('Spring' + 'srch_destination_id_'+str(srch_destination_id))
            ...
            if hotel_country != '':
                ...
                hsh1 = hash('Fall' + 'hotel_country_'+str(hotel_country))
                hsh2 = hash('Winter' + 'hotel_country_'+str(hotel_country))
                hsh3 = hash('Spring' + 'hotel_country_'+str(hotel_country))
        ...
        if season == "Fall":
            ...
            if user_location_city != '' and orig_destination_distance != '':
                ...
                hsh1 = (hash('Winter' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
                hsh2 = (hash('Spring' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
                hsh3 = (hash('Summer' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
            ...
            if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and book_year == 2014:
                ...
                hsh1 = (hash('Winter' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
                hsh2 = (hash('Spring' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
                hsh3 = (hash('Summer' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
            ...
            if srch_destination_id != '':
                ...
                hsh1 = hash('Winter' + 'srch_destination_id_'+str(srch_destination_id))
                hsh2 = hash('Spring' + 'srch_destination_id_'+str(srch_destination_id))
                hsh3 = hash('Summer' + 'srch_destination_id_'+str(srch_destination_id))
            ...
            if hotel_country != '':
                ...
                hsh1 = hash('Winter' + 'hotel_country_'+str(hotel_country))
                hsh2 = hash('Spring' + 'hotel_country_'+str(hotel_country))
                hsh3 = hash('Summer' + 'hotel_country_'+str(hotel_country))
        ...
        if season == "Winter":
            ...
            if user_location_city != '' and orig_destination_distance != '':
                ...
                hsh1 = (hash('Spring' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
                hsh2 = (hash('Summer' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
                hsh3 = (hash('Fall' + 'user_location_city_'+str(user_location_city) + '_orig_destination_distance_' + str(orig_destination_distance)))
            ...
            if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and book_year == 2014:
                ...
                hsh1 = (hash('Spring' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
                hsh2 = (hash('Summer' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
                hsh3 = (hash('Fall' + 'srch_destination_id_' + str(srch_destination_id) + "_hotel_country_" + str(hotel_country) + "_hotel_market_"+str(hotel_market)))
            ...
            if srch_destination_id != '':
                ...
                hsh1 = hash('Spring' + 'srch_destination_id_'+str(srch_destination_id))
                hsh2 = hash('Summer' + 'srch_destination_id_'+str(srch_destination_id))
                hsh3 = hash('Fall' + 'srch_destination_id_'+str(srch_destination_id))
            ...
            if hotel_country != '':
                ...
                hsh1 = hash('Spring' + 'hotel_country_'+str(hotel_country))
                hsh2 = hash('Summer' + 'hotel_country_'+str(hotel_country))
                hsh3 = hash('Fall' + 'hotel_country_'+str(hotel_country))
