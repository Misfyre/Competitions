...
def test_setting(script_setting):
    ...
    if script_setting == 0:
        ...
        return train_path, test_path, cv_path

    elif script_setting == 1:
...
def prepare_arrays_validation(train_path):
    ...
    while 1:
        ...
        if user_location_country != '' and srch_destination_id != '' and srch_ci_month != '':
...
train_path, test_path, cv_path = test_setting(script_setting)
...
if script_setting == 0:
    ...
    print ('')
    print ('Error... Script Setting Misunderstood')
