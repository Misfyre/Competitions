...
train = pd.read_csv(os.path.expanduser('~/Desktop/BNP Paribas/Data/train.csv'))
test = pd.read_csv(os.path.expanduser('~/Desktop/BNP Paribas/Data/test.csv'))
...
g={'ne':500,'md':40,'mf':60,'rs':2016} #change to g={'ne':500,'md':40,'mf':60,'rs':2016}
...
id_results.to_csv(os.path.expanduser('~/Desktop/BNP Paribas/Output/results_analysis.csv'), index=False)
ds = id_results[['ID','avg']]
ds.columns = ['ID','PredictedProb']
ds.to_csv(os.path.expanduser('~/Desktop/BNP Paribas/Output/submission.csv'),index=False)
